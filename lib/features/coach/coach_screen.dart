...
const _cards = <_Card>[
  ...
  _Card(
    'Health Connect',
    'Health goals score themselves.',
    'Saara reads steps, sleep, and weight from Health Connect — no manual logging.',
    'Example',
    'Samsung Health → Health Connect → Saara. “Walk 8k” ticks on its own from your real steps.',
    'Effort-free, honest verification for health commitments.',
  ),
  _Card(
    'Attach & link',
    'Keep the receipts.',
    'Attach an image from your phone, or link a Google Drive / Docs / Sheets file (pick it from Drive) to a task. Saara stores the link — it opens in Google, governed by your own sharing.',
    'Example',
    '“Review the MoM before the sync” → pick the doc from Drive → tap Open document later.',
  ...
  _Card(
    ...
    'Example',
    'Keep 62% of your words → Professional. Push past 86% → Masterful, trusted without question.',
